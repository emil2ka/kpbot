...
async def find_trending_sourcing_niches(category: str = "все категории") -> NicheTrendsResponse:
    """Generate top high-margin, low-competition sourcing opportunities for Kaspi.kz sellers."""
    opportunities = [
        NicheOpportunity(
            ...
            why_promising="Стабильный высокий спрос круглый год, компактный объем (дешевое авто-карго).",
        ...
        NicheOpportunity(
            ...
            why_promising="Высокий чековый сегмент, легкая вакуумная упаковка (низкая стоимость за куб).",
        ...
        NicheOpportunity(
            ...
            why_promising="Трендовый авто-гаджет, высокий спрос среди автовладельцев в Казахстане.",
    ...
    return NicheTrendsResponse(
        category=category,
        summary_ru="Подборка 3 высокомаржинальных ниш из Китая с целевой маржой от 35% и легкой логистикой.",
